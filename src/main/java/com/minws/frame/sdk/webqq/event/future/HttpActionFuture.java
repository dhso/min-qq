 ...
 */
package com.minws.frame.sdk.webqq.event.future;

import com.minws.frame.sdk.webqq.QQException;
import com.minws.frame.sdk.webqq.action.HttpAction;
...
public class HttpActionFuture extends AbstractActionFuture{
	 ...
	 *
	 * @param action a {@link com.minws.frame.sdk.webqq.action.HttpAction} object.
	 */
	...
	/* (non-Javadoc)
	 * @see com.minws.frame.sdk.webqq.event.QQActionFuture#isCancelable()
	 */
	/** {@inheritDoc} */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.minws.frame.sdk.webqq.event.QQActionFuture#cancel()
	 */
	/** {@inheritDoc} */
	@Override
